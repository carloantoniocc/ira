...
do{
   if ($row_rs['valoreal']==0){    
       $query="select fechai,fechat
               from semana where semana=".$row_rs['semana'];
       $rss=safe_query($query);
     ...
     if($totalRows_rsu >0 && $row_rsu['toturg'] >0)
         $punto[]=$row_rsu['toturg'];
      else
         $punto[]="";
   }
    else
