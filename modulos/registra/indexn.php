...
$updateSQL = sprintf("UPDATE aturg_urbana SET fecha=%s, totm1=%s, tot1a9=%s, tot10a14=%s, tot15a64=%s, tot65ym=%s,
  ...
  $updateSQL=sprintf("UPDATE aturgo SET fecha=%s, infarto_m1=%s, infarto_1a4=%s, infarto_5a14=%s, infarto_15a64=%s, infarto_65ym=%s,
					  ...
					  diarrea_m1=%s, diarrea_1a4=%s, diarrea_5a14=%s, diarrea_15a64=%s, diarrea_65ym=%s ,
					  ...
					  demas_m1=%s, demas_1a4=%s, demas_5a14=%s, demas_15a64=%s, demas_65ym=%s 
					   ...
					   GetSQLValueString($_POST['diarrea_m1'], "int"),

                       GetSQLValueString($_POST['diarrea_1a4'], "int"),

                       GetSQLValueString($_POST['diarrea_5a14'], "int"),

                       GetSQLValueString($_POST['diarrea_15a64'], "int"),

                       GetSQLValueString($_POST['diarrea_65ym'], "int"),
...
//echo "entra id=" . $id_estab;
  ...
  $Result1 = safe_query($insertSQL);
     ...
     if($_POST['otrasext_65ym']=="")$_POST['otrasext_65ym']=0;
	  ...
	  if($_POST['diarrea_m1']=="")$_POST['diarrea_m1']=0;

     if($_POST['diarrea_1a4']=="")$_POST['diarrea_1a4']=0;

     if($_POST['diarrea_5a14']=="")$_POST['diarrea_5a14']=0;

     if($_POST['diarrea_15a64']=="")$_POST['diarrea_15a64']=0;

     if($_POST['diarrea_65ym']=="")$_POST['diarrea_65ym']=0;
	  ...
	  $insertSQL = sprintf("INSERT INTO aturgo (id_estab, fecha, 
						...
						diarrea_m1, diarrea_1a4, diarrea_5a14, diarrea_15a64, diarrea_65ym,
...
$query_rsa="select *,
			...
			diarrea_m1+diarrea_1a4+diarrea_5a14+diarrea_15a64+diarrea_65ym as totdiarrea,
...
$plano.="Diarrea Aguda               ".$row_rsa['totdiarrea']."\t ".$row_rsa['diarrea_m1']."\t ".$row_rsa['diarrea_1a4']."\t ".

$row_rsa['diarrea_5a14']."\t ".$row_rsa['diarrea_15a64']."\t ".$row_rsa['diarrea_65ym']."\n";
...
print <<<EOQ
   ...
   <tr> 
    ...
    <strong>TOTAL DIARREA AGUDA</strong></font></div></td>

	<td><div align="center"> <font color="#0000CC" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> 

EOQ;

    echo "<input name=\"totdiarrea\" type=\"text\" id=\"totdiarrea\" value=\"";

	 if(!empty($row_rsfh['totdiarrea']))

        echo $row_rsfh['totdiarrea'];
...
EOQ;
    ...
    echo "<input name=\"diarrea_m1\" type=\"text\" id=\"diarrea_m1\" value=\"";

     if(!empty($row_rsfh['diarrea_m1']))

        echo $row_rsfh['diarrea_m1'];
...
."onBlur=\"return calculod(document.f.diarrea_m1,document.f.diarrea_m1h, document.f.totdiarrea);\" >";

   echo "<input name=\"diarrea_m1h\" type=\"hidden\" id=\"diarrea_m1h\" value=\"";

     if( isset( $row_rsfh['diarrea_m1']))
...
EOQ;
    ...
    echo "<input name=\"diarrea_1a4\" type=\"text\" id=\"diarrea_1a4\" value=\"";

     if(!empty($row_rsfh['diarrea_1a4']))

        echo $row_rsfh['diarrea_1a4'];
...
."onBlur=\"return calculod(document.f.diarrea_1a4,document.f.diarrea_1a4h,document.f.totdiarrea)\" >";

   echo "<input name=\"diarrea_1a4h\" type=\"hidden\" id=\"diarrea_1a4h\" value=\"";

     if( isset( $row_rsfh['diarrea_1a4']))
...
EOQ;
    ...
    echo "<input name=\"diarrea_5a14\" type=\"text\" id=\"diarrea_5a14\" value=\"";

     if(!empty($row_rsfh['diarrea_5a14']))

        echo $row_rsfh['diarrea_5a14'];
...
."onBlur=\"return calculod(document.f.diarrea_5a14,document.f.diarrea_5a14h,document.f.totdiarrea)\" >";

   echo "<input name=\"diarrea_5a14h\" type=\"hidden\" id=\"diarrea_5a14h\" value=\""; 

     if( isset( $row_rsfh['diarrea_5a14']))
...
EOQ;
    ...
    echo "<input name=\"diarrea_15a64\" type=\"text\" id=\"diarrea_15a64\" value=\"";

     if(!empty($row_rsfh['diarrea_15a64']))

        echo $row_rsfh['diarrea_15a64'];
...
."onBlur=\"return calculod(document.f.diarrea_15a64,document.f.diarrea_15a64h,document.f.totdiarrea)\" >";

   echo "<input name=\"diarrea_15a64h\" type=\"hidden\" id=\"diarrea_15a64h\" value=\""; 

     if( isset( $row_rsfh['diarrea_15a64']))
...
EOQ;
    ...
    echo "<input name=\"diarrea_65ym\" type=\"text\" id=\"diarrea_65ym\" value=\"";

     if(!empty($row_rsfh['diarrea_65ym']))

        echo $row_rsfh['diarrea_65ym'];
...
."onBlur=\"return calculod(document.f.diarrea_65ym,document.f.diarrea_65ymh,document.f.totdiarrea)\" >";

   echo "<input name=\"diarrea_65ymh\" type=\"hidden\" id=\"diarrea_65ymh\" value=\"";

     if( isset( $row_rsfh['diarrea_65ym']))
...
// Llamada a las funciones de la pagina
...
/*	um65ym=parseFloat(document.f.circ_65ym.value) + parseFloat(document.f.demas_65ym.value);
	...
	oa65ym=parseFloat(document.f.circ_65ym.value) + parseFloat(document.f.demas_65ym.value)+ parseFloat(document.f.trauma_65ym.value)
	      +  parseFloat(document.f.diarrea_65ym.value);
...
/*	um15a64=parseFloat(document.f.circ_15a64.value) + parseFloat(document.f.demas_15a64.value);
	...
	oa15a64=parseFloat(document.f.circ_15a64.value) + parseFloat(document.f.demas_15a64.value)+ parseFloat(document.f.trauma_15a64.value) +
	        parseFloat(document.f.diarrea_15a64.value);
...
/*	um5a14=parseFloat(document.f.circ_5a14.value) + parseFloat(document.f.demas_5a14.value);
	...
	oa5a14= parseFloat(document.f.circ_5a14.value) + parseFloat(document.f.demas_5a14.value)+ parseFloat(document.f.trauma_5a14.value) +
	       parseFloat(document.f.diarrea_5a14.value);
...
/*	um1a4=parseFloat(document.f.circ_1a4.value) + parseFloat(document.f.demas_1a4.value);
	...
	oa1a4=parseFloat(document.f.circ_1a4.value) + parseFloat(document.f.demas_1a4.value)+ parseFloat(document.f.trauma_1a4.value) +
			parseFloat(document.f.diarrea_1a4.value);
...
/*	umm1=parseFloat(document.f.circ_m1.value) + parseFloat(document.f.demas_m1.value);
	...
	oam1=parseFloat(document.f.circ_m1.value) + parseFloat(document.f.cirurg_m1.value)+parseFloat(document.f.demas_m1.value)+ 
	     parseFloat(document.f.trauma_m1.value) + parseFloat(document.f.diarrea_m1.value);
	...
	otro=parseFloat(document.f.totcirc.value) + parseFloat(document.f.tottrauma.value) + parseFloat(document.f.totdemas.value)
	     + parseFloat(document.f.totdiarrea.value);
