...
$datos="<form method=\"post\" name=\"f\" action=\"index.php?page=registra&file=index&func=modifica\">"
...
$query="select fecha, id_estab,
		...
		iraltas_m1+ iraltas_1a9 + iraltas_10a14 + iraltas_15a64 + iraltas_65ym +
               ...
               larin_m1 + asma_m1 + resto_m1 + iraltas_m1         as totinfresto,

               larin_1a9 + asma_1a9 + resto_1a9   +  iraltas_1a9 as totresto1a9,

		larin_10a14+ asma_10a14+ resto_10a14 + iraltas_10a14 as totresto10a14,

               larin_15a64 + asma_15a64 + resto_15a64 + iraltas_15a64 as totresto15a64,

               larin_65ym + asma_65ym + resto_65ym + iraltas_65ym 	as totresto65ym,
...
$a12=$a22+$row_rsm['totm1']+$row_rsm['totsinm1'];

$a13=$a23+$row_rsm['tot1a9']+$row_rsm['totsin1a9'];

$a132=$a232+$row_rsm['tot10a14']+$row_rsm['totsin10a14'];

$a14=$a24+$row_rsm['tot15a64']+$row_rsm['totsin15a64'];

$a15=$a25+$row_rsm['tot65ym']+$row_rsm['totsin65ym'];
...
$plano.="Atenciones diarias de Urgencias por causas respiratorias\n";

$plano.="Causas \t\t\t Total \t -1 año \t1-4 años\t5-14años\t15-64años\t65y más\n";

$plano.="Total atenciones urgencia \t".$a11."\t\t".$a12."\t\t".$a13."\t".$a132."\t\t".$a14."\t\t".$a15."\n";

$plano.="Total Causas respiratorias \t".$a21."\t\t".$a22."\t\t".$a23."\t".$a232."\t\t".$a24."\t\t".$a25."\n";

$plano.="Bronquitis-SOB \t\t\t".$a31."\t\t".$a32."\t\t".$a33."\t".$a332."\t\t".$a34."\t\t".$a35."\n";

$plano.="Influenza \t \t \t\t".$a41."\t\t".$a42."\t\t".$a43."\t".$a432."\t\t".$a44."\t\t".$a45."\n";

$plano.="Neumonías \t \t \t\t".$a51."\t\t".$a52."\t\t".$a53."\t".$a532."\t\t".$a54."\t\t".$a55."\n";

$plano.="Resto causas respiratorias \t".$a61."\t\t".$a62."\t\t".$a63."\t".$a632."\t\t".$a64."\t\t".$a65."\n\n";



$plano.="Hospitalizaciones diarias en Urgencia por causas respiratorias\n";

$plano.="Total\t-1año\t1-4años\t5-14años\t15-64años\t65y más\n";

$plano.=$h1."\t  ".$h2."\t  ".$h3."\t\t  ".$h32."\t\t  ".$h4."\t\t  ".$h5."\n\n";
...
//$headers .= 'To: DEIS <daimo.sanchez@redsalud.gov.cl>' . "\r\n";



$headers .= 'CC: Lupe <guadalupe.pastore@redsalud.gov.cl>' . "\r\n";

//$headers .= 'CC: Daimo <dsanchez@ssmoc.cl>' . "\r\n";
