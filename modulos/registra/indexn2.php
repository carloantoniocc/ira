...
// Link a correo
 if(strcmp($_SESSION['nivelautorizado'],'administrador')==0 ||strcmp($_SESSION['nivelautorizado'],'direccion')==0 ){ 
   if($_SESSION['id_estab']==1|| $_SESSION['id_estab']==3)
...
$a11=$row_rsm['toturg'];
$a12=$row_rsm['totrespm1']+$row_rsa['totcirc_m1']+$row_rsa['tottrauma_m1']+$row_rsa['demas_m1'];
$a13=$row_rsm['totresp1a9']+$row_rsa['totcirc_1a4']+$row_rsa['tottrauma_1a4']+$row_rsa['demas_1a4'];
$a132=$row_rsm['totresp10a14']+$row_rsa['totcirc_5a14']+$row_rsa['tottrauma_5a14']+$row_rsa['demas_5a14'];
$a14=$row_rsm['totresp15a64']+$row_rsa['totcirc_15a64']+$row_rsa['tottrauma_15a64']+$row_rsa['demas_15a64'];
$a15=$row_rsm['totresp65ym']+$row_rsa['totcirc_65ym']+$row_rsa['tottrauma_65ym']+$row_rsa['demas_65ym'];
...
if(isset($e)&&isset($f)){
$query_rsfh = "SELECT * 
, circulatorias_m1 + trauma_m1 + demas_m1  as tothospo_m1
, circulatorias_1a4 + trauma_1a4 + demas_1a4  as tothospo_1a4
, circulatorias_5a14 + trauma_5a14 + demas_5a14  as tothospo_5a14
, circulatorias_15a64 + trauma_15a64 + demas_15a64 as tothospo_15a64
, circulatorias_65ym + trauma_65ym + demas_65ym as tothospo_65ym
,circulatorias_m1 + trauma_m1 + demas_m1 +
circulatorias_1a4 + trauma_1a4 + demas_1a4 +
circulatorias_5a14 + trauma_5a14 + demas_5a14  +
circulatorias_15a64 + trauma_15a64 + demas_15a64 +
circulatorias_65ym + trauma_65ym + demas_65ym as tothospo
, circulatorias_m1+circulatorias_1a4+circulatorias_5a14+circulatorias_15a64+circulatorias_65ym as totcirculatorias
, trauma_m1+trauma_1a4+trauma_5a14+trauma_15a64+trauma_65ym as tottrauma
, demas_m1+demas_1a4+demas_5a14+demas_15a64+demas_65ym as totdemas
...
/*	umm1=parseFloat(document.f.circ_m1.value) + parseFloat(document.f.demas_m1.value);
	...
	oam1=parseFloat(document.f.circ_m1.value) + parseFloat(document.f.demas_m1.value)+ parseFloat(document.f.trauma_m1.value);
