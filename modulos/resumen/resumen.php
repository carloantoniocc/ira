...
if(strcmp($_POST['nivel'],'servicio')==0)
        $query_rs.=" FROM aturg_urbana where fecha between '".$fechai ."' and '".$fechat ."'";
if(strcmp($_POST['nivel'],'hospital')==0)
        $query_rs.=" FROM aturg_urbana , establecimiento
                   where aturg_urbana.id_estab=establecimiento.id
                   and (tipo='urbano' or tipo='provincial') 
                   and fecha between '".$fechai ."' and '".$fechat ."'";
if(strcmp($_POST['nivel'],'urbano')==0)
        $query_rs.=" FROM aturg_urbana , establecimiento
                   where aturg_urbana.id_estab=establecimiento.id
                   and tipo='urbano' 
                   and fecha between '".$fechai ."' and '".$fechat ."'";
if(strcmp($_POST['nivel'],'sapu')==0)
        $query_rs.=" FROM aturg_urbana , establecimiento
                   where aturg_urbana.id_estab=establecimiento.id
                   and tipo='sapu' 
                   and fecha between '".$fechai ."' and '".$fechat ."'";
...
echo "<table width=\"600\" align=\"center\">"
 ...
 ."   de Urgencia y Causas Respiratorias<br>Nivel: <i>".$_POST['nivel']."</i> "
...
."Grupos de edad:</font></strong></div></td>"
  ...
  ."Total urgencias </font></strong></font></div></td>"
   ...
   ."<td width=\"53\"> "
     ."<div align=\"right\"><font size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\"><strong><font color=\"#0000CC\">"
  ."Total urg.Médicas</font></strong></font></div></td>"
   ."<td width=\"56\"> "
     ."<div align=\"right\"><font size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\"><strong><font color=\"#0000CC\">"
...
// hospitales solo
if( strcmp($_POST['nivel'],'servicio')==0 ||
    strcmp($_POST['nivel'],'hospital')==0 ||
    strcmp($_POST['nivel'],'urbano')==0 ) {
...
if(strcmp($_POST['nivel'],'servicio')==0)
        $query_rsh.=" FROM hospitaliza where fecha between '".$fechai ."' and '".$fechat ."'";
if(strcmp($_POST['nivel'],'hospital')==0)
        $query_rsh.=" FROM hospitaliza , establecimiento
                   where hospitaliza.id_estab=establecimiento.id
                   and (tipo='urbano' or tipo='provincial') 
                   and fecha between '".$fechai ."' and '".$fechat ."'";
if(strcmp($_POST['nivel'],'urbano')==0)
        $query_rsh.=" FROM hospitaliza , establecimiento
...
if(strcmp($_POST['nivel'],'servicio')==0)
        $query_rse.=" FROM egresos where fecha between '".$fechai ."' and '".$fechat ."'";
if(strcmp($_POST['nivel'],'hospital')==0)
        $query_rse.=" FROM egresos , establecimiento
                   where egresos.id_estab=establecimiento.id
                   and (tipo='urbano' or tipo='provincial') 
                   and fecha between '".$fechai ."' and '".$fechat ."'";
if(strcmp($_POST['nivel'],'urbano')==0)
        $query_rse.=" FROM egresos , establecimiento
...
// solo sapus
if(strcmp($_POST['nivel'],'servicio')==0 || strcmp($_POST['nivel'],'sapu')==0 )
{
...
if(strcmp($_POST['nivel'],'servicio')==0)
        $query_rsd.=" FROM derivaciones where fecha between '".$fechai ."' and '".$fechat ."'";
if(strcmp($_POST['nivel'],'sapu')==0)
        $query_rsd.=" FROM derivaciones , establecimiento
                   where derivaciones.id_estab=establecimiento.id
                   and tipo='sapu' 
                   and fecha between '".$fechai ."' and '".$fechat ."'";
...
if(strcmp($_POST['nivel'],'servicio')==0)
        $query_rsfh.=" FROM fallecidoh where fecha between '".$fechai ."' and '".$fechat ."'";
if(strcmp($_POST['nivel'],'hospital')==0)
        $query_rsfh.=" FROM fallecidoh , establecimiento
                   where fallecidoh.id_estab=establecimiento.id
                   and (tipo='urbano' or tipo='provincial') 
                   and fecha between '".$fechai ."' and '".$fechat ."'";
if(strcmp($_POST['nivel'],'urbano')==0)
        $query_rsfh.=" FROM fallecidoh , establecimiento
...
echo "<body><form action=\"index.php?page=resumen&file=resumen&func=resumen\" method=\"post\" name=\"form1\">"
 ."<table width=\"550\" border=\"0\" align=\"center\">"
 ." <caption>"
 ." <font color=\"#0000CC\" size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><strong>Resumen "
 ." de Atenciones de Urgencia<br>"
 ."Por niveles</strong>&nbsp;&nbsp;&nbsp;</font>" 
...
."      Seleccione su Nivel Resumen:</font></strong></td>"
."      <td> <strong><font color=\"#0000CC\" size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\">" 
."        <select name=\"nivel\">"
."          <option value=\"servicio\" >Todo el Servicio</option>"
."          <option value=\"hospital\" >Hospitales(Urb.+Prov.)</option>"
."          <option value=\"urbano\" >Hospitales Urbanos</option>"
."          <option value=\"sapu\" >SAPUS</option>"
."        </select>"
."        </font></strong></td>"
."    </tr>"
 ."<tr> "
