...
$query_rsfh = "SELECT 
 ...
 sum(diarrea_m1) as diarrea_m1,
 sum(diarrea_1a4) as diarrea_1a4,
 sum(diarrea_5a14 ) as diarrea_5a14 ,
 sum(diarrea_15a64) as diarrea_15a64,
 sum(diarrea_65ym) as diarrea_65ym,
...
, sum(diarrea_m1 + diarrea_1a4 + diarrea_5a14 + diarrea_15a64 + diarrea_65ym) as totdiarrea
...
print <<<EOQ
  <tr> 
    <td><div align="center"><font color="#0000CC" size="1" face="Verdana, Arial, Helvetica, sans-serif">
    <strong>TOTAL DIARREAS AGUDAS</strong></font></div></td>
	<td><div align="center"> <font color="#0000CC" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> 
EOQ;
    echo "<input name=\"totdiarrea\" type=\"text\" id=\"totdiarrea\" value=\"".$row_rsfh['totdiarrea'];
    echo "\" size=\"4\" maxlength=\"4\" readonly=\"true\">";
print <<<EOQ
        </strong></font></div></td>
    <td><div align="center"> <font color="#0000CC" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> 
EOQ;
    echo "<input name=\"diarrea_m1\" type=\"text\" id=\"diarrea_m1\" value=\"".$row_rsfh['diarrea_m1'];
    echo "\" size=\"4\" maxlength=\"4\" >";
print <<<EOQ
        </strong></font></div></td>
    <td><div align="center"> <font color="#0000CC" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>
EOQ;
    echo "<input name=\"diarrea_1a4\" type=\"text\" id=\"demas_1a4\" value=\"".$row_rsfh['diarrea_1a4'];
    echo "\" size=\"4\" maxlength=\"4\" >";
print <<<EOQ
        </strong></font></div></td>
    <td><div align="center"> <font color="#0000CC" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> 
EOQ;
    echo "<input name=\"diarrea_5a14\" type=\"text\" id=\"diarrea_5a14\" value=\"".$row_rsfh['diarrea_5a14'];
    echo "\" size=\"4\" maxlength=\"4\" >";
print <<<EOQ
        </strong></font></div></td>
    <td><div align="center"> <font color="#0000CC" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> 
EOQ;
    echo "<input name=\"diarrea_15a64\" type=\"text\" id=\"diarrea_15a64\" value=\"".$row_rsfh['diarrea_15a64'];
    echo "\" size=\"4\" maxlength=\"4\" >";
print <<<EOQ
        </strong></font></div></td>
<td><div align="center"> <font color="#0000CC" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>
EOQ;
    echo "<input name=\"diarrea_65ym\" type=\"text\" id=\"demas_65ym\" value=\"".$row_rsfh['diarrea_65ym'];
    echo "\" size=\"4\" maxlength=\"4\" >";
print <<<EOQ
        </strong></font></div></td>
  </tr> 
EOQ;
$data.="Total Diarreas\t";
$data.=$row_rsfh['totdiarrea']."\t";
$data.=$row_rsfh['diarrea_m1']."\t";
$data.=$row_rsfh['diarrea_1a4']."\t";
$data.=$row_rsfh['diarrea_5a14']."\t";
$data.=$row_rsfh['diarrea_15a64']."\t";
$data.=$row_rsfh['diarrea_65ym']."\t";
$data.="\n";
fwrite($fp,$data);
$data=""; 
print <<<EOQ
...
if(strcmp($_SESSION['tipo'],'urbano')==0 || strcmp($_SESSION['tipo'],'provincial')==0){
   $query_rsh="select sum(pbm1) as pbm1,
					  ...
					  sum(utibm1) as utibm1,
					  sum(utib1_9) as utib1_9,
					  sum(utib10_14) as utib10_14,
					  sum(utib15_64) as utib15_64,
					  sum(utib65ym) as utib65ym,
					  sum(utibotras) as utibotras,
					  sum(utitm1) as utitm1,
					  sum(utit1_9) as utit1_9,
					  sum(utit10_14) as utit10_14,
					  sum(utit15_64) as utit15_64,
					  sum(utit65ym) as utit65ym,
					  sum(utitotras) as utitotras,
					  sum(ucibm1) as ucibm1,
					  sum(ucib1_9) as ucib1_9,
					  sum(ucib10_14) as ucib10_14,
					  sum(ucib15_64) as ucib15_64,
					  sum(ucib65ym) as ucib65ym,
					  sum(ucibotras) as ucibotras,
					  sum(ucitm1) as ucitm1,
					  sum(ucit1_9) as ucit1_9,
					  sum(ucit10_14) as ucit10_14,
					  sum(ucit15_64) as ucit15_64,
					  sum(ucit65ym) as ucit65ym,
					  sum(ucitotras) as ucitotras,
				sum(utibm1 + utib1_9 + utib10_14 + utib15_64 + utib65ym ) as utibsubtot,
            	sum(utitm1 + utit1_9 + utit10_14 + utit15_64 + utit65ym ) as utitsubtot,
            	sum(ucibm1 + ucib1_9 + ucib10_14 + ucib15_64 + ucib65ym ) as ucibsubtot,
            	sum(ucitm1 + ucit1_9 + ucit10_14 + ucit15_64 + ucit65ym ) as ucitsubtot,
			   ...
			   sum(utibm1 + utib1_9 + utib10_14 + utib15_64 + utib65ym + utibotras) as utibtot,
            	sum(utitm1 + utit1_9 + utit10_14 + utit15_64 + utit65ym + utitotras) as utittot,
            	sum(ucibm1 + ucib1_9 + ucib10_14 + ucib15_64 + ucib65ym + ucibotras) as ucibtot,
            	sum(ucitm1 + ucit1_9 + ucit10_14 + ucit15_64 + ucit65ym + ucitotras) as ucittot,
...
<table width="600" border="0" align="center">
  ...
  <tr> 
    ...
    <td colspan="2"> <div align="center"><font size="1"><strong><font color="#0000CC" face="Verdana, Arial, Helvetica, sans-serif">Ni&ntilde;os</font></strong></font></div></td>
    <td colspan="4"> <div align="center"><font size="1"><strong><font color="#0000CC" face="Verdana, Arial, Helvetica, sans-serif">Adultos Medicina</font></strong></font></div></td>
	<td colspan="4"> <div align="center"><font size="1"><strong><font color="#0000CC" face="Verdana, Arial, Helvetica, sans-serif">Unidad Pac.Criticos</font></strong></font></div></td>
  </tr>
  <tr> 
	...
	<td colspan="2"><div align="center"><font size="1"><strong><font color="#0000CC" face="Verdana, Arial, Helvetica, sans-serif">UTI</font></strong></font></div></td>
    <td colspan="2"><div align="center"><font size="1"><strong><font color="#0000CC" face="Verdana, Arial, Helvetica, sans-serif">UCI</font></strong></font></div></td>
  </tr>
  <tr> 
...
print <<<EOQ
	...
	<td><div align="center"> <font size="1" face="Verdana, Arial, Helvetica, sans-serif">
EOQ;
   echo "<input name=\"utibsubtot\" type=\"text\" id=\"utibsubtot\" value=\"";  
          echo $row_rsh['utibsubtot'];
   echo "\" size=\"4\" maxlength=\"4\" >";
print <<<EOQ
        </font></div></td>
    <td><div align="center"> <font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
EOQ;
   echo "<input name=\"utitsubtot\" type=\"text\" id=\"utitsubtot\" value=\"";  
          echo $row_rsh['utitsubtot'];
   echo "\" size=\"4\" maxlength=\"4\" >";
print <<<EOQ
        </font></div></td>
    <td><div align="center"> <font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
EOQ;
   echo "<input name=\"ucibsubtot\" type=\"text\" id=\"ucibsubtot\" value=\"";  
          echo $row_rsh['ucibsubtot'];
   echo "\" size=\"4\" maxlength=\"4\" >";
print <<<EOQ
    </font></div></td>
    <td><div align="center"> <font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
EOQ;
   echo "<input name=\"ucitsubtot\" type=\"text\" id=\"ucitsubtot\" value=\"";  
          echo $row_rsh['ucitsubtot'];
   echo "\" size=\"4\" maxlength=\"4\" >";
print <<<EOQ
        </font></div></td>		
...
$data.="15-64 años\t".$row_rsh['pb15_64']."\t".$row_rsh['po15_64']."\t".
