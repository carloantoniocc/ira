...
$imp= "<br><font size=\"1\">Establecimiento:</font> <i>".$_SESSION['nombre']."</i> "
 ."&nbsp;&nbsp;Fecha: &nbsp;<font size=\"1\">".$_POST['fechai']."&nbsp;&nbsp;  al  &nbsp;&nbsp;" .$_POST['fechat']."</font>";
echo $imp;
$data.=$imp;
...
//echo "<a href=\"mailto:dsl@vtr.net\">Enviar Correo</a>";
// Enviar correo
/*
...
$headers .= 'To: Daimo <dsl@vtr.net>' . "\r\n";
$headers .= 'From: Felices IRAs <dsanchez@ssmoc.cl>' . "\r\n";
